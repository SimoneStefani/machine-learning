...
# Returns:    loss -- the loss function (vanilla logistic loss)
...
# Returns:    gradients -- A dictionary with the gradients with respect to each parameter, activation and
...
# Arguments:  parameters -- python dictionary containing parameters 
#             grads -- python dictionary containing gradients, output of n_model_backward
# Returns:    parameters -- python dictionary containing updated parameters 
...
# Arguments:  a3 -- post-activation, output of forward propagation
#             Y -- "true" labels vector, same shape as a3
# Returns:    loss - value of the loss function
